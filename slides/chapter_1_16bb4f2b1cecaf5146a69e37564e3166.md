...
`@script`
In the part we are going to learn about Bag Of Words Model, which is popular representation in NLP for text, we will Bag Of Words Model for converting text into numerical features.
